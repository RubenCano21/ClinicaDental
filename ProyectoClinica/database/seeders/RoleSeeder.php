...
class RoleSeeder extends Seeder
{
    ...
    $role2->syncPermissions( ['ver dashboard', 'crear cita', 'actualizar cita', 'cancelar cita', 'ver especialidades', 'ver tratamientos', 'crear tratamiento', 'actualizar tratamiento', 'ver odontograma', 'ver reservas', 'crear reserva', 'actualizar reserva', 'eliminar reserva', 'ver historial clinico', 'ver odontologos']);
    $role3->syncPermissions( ['ver dashboard', 'crear cita', 'actualizar cita', 'cancelar cita', 'ver usuarios', 'crear usuario', 'eliminar usuario', 'actualizar usuario', 'ver bitacora', 'ver especialidades', 'asignar especialidad', 'eliminar especialidad', 'ver tratamientos', 'crear tratamiento', 'actualizar tratamiento', 'ver odontograma', 'actualizar odontograma', 'ver reservas', 'crear reserva', 'actualizar reserva', 'eliminar reserva', 'ver historial clinico', 'actualizar historial clinico', 'ver pacientes', 'crear pacientes', 'eliminar pacientes', 'actualizar pacientes', 'ver odontologos', 'crear odontologo', 'eliminar odontologo', 'actualizar odontologo', 'ver recepcionistas', 'crear recepcionista', 'eliminar recepcionista', 'actualizar recepcionista']);
    $role4->syncPermissions( ['ver dashboard', 'crear cita', 'actualizar cita', 'cancelar cita', 'ver usuarios', 'crear usuario', 'eliminar usuario', 'actualizar usuario', 'ver bitacora', 'ver especialidades', 'asignar especialidad', 'eliminar especialidad', 'ver tratamientos', 'crear tratamiento', 'actualizar tratamiento', 'ver odontograma', 'actualizar odontograma', 'ver reservas', 'crear reserva', 'actualizar reserva', 'eliminar reserva', 'ver historial clinico', 'actualizar historial clinico', 'ver pacientes', 'crear pacientes', 'eliminar pacientes', 'actualizar pacientes', 'ver odontologos', 'crear odontologo', 'eliminar odontologo', 'actualizar odontologo', 'ver recepcionistas', 'crear recepcionista', 'eliminar recepcionista', 'actualizar recepcionista']);
